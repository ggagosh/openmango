...
fn default_keybindings() -> Vec<KeyBinding> {
    vec![
        ...
        KeyBinding::new("cmd-shift-k", ClearForgeOutput, Some("ForgeView")),
        KeyBinding::new("ctrl-shift-k", ClearForgeOutput, Some("ForgeView")),
        KeyBinding::new("cmd-shift-k", ClearForgeOutput, Some("ForgeView > Input")),
        KeyBinding::new("ctrl-shift-k", ClearForgeOutput, Some("ForgeView > Input")),
