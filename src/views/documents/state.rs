...
pub struct CollectionView {
    ...
    /// "Ask AI" for the filter: the box it is typed in, and what it is doing.
    pub(crate) ask_ai_state: Option<Entity<InputState>>,
    pub(crate) ask_ai_subscription: Option<gpui_kit::Subscription>,
    pub(crate) ask_ai_open: bool,
