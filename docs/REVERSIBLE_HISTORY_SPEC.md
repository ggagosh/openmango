...
> **Status:** Manual single-document and bounded bulk transition slices implemented
...
- grouped bulk revert, metadata/snapshot recipes, retention/purge controls, and agent/MCP routing remain future slices.
